			...
			<div id="center">
				<div id="griddiv-left" class="white">
					...
					<div id="rowmid" class="white">
						<input id="textbox-large" name="text-place" class="enjoy-css" type="text" <?php if(isset($_POST["text-place"])){ ?> placeholder="<?= ucfirst($_POST["text-place"]) ?>" <?php} elseif(isset($_SESSION["address"])){ ?> placeholder="<?= ucfirst($_SESSION["address"]) ?>"<?php }else{ ?> placeholder="Wohnort" <?php }  ?>>
					</div>
