			...
			<div id="center">
				<div id="griddiv-left" class="white">
					...
					<div id="rowmid" class="white">
						<input id="textbox-large" name="text-place" class="enjoy-css" type="text" <?php if(isset($_POST["address"])){ ?> placeholder="<?= ucfirst($_POST["address"]) ?>" <?php} elseif(isset($_SESSION["address"])){ ?> placeholder="<?= ucfirst(getUserInfo()) ?>"<?php }else{ ?> placeholder="Wohnort" <?php }  ?>>
					</div>
